...
# aws ecr get-login-password | docker login --username AWS --password-stdin 348949640551.dkr.ecr.ap-south-1.amazonaws.com/demo-app
# docker tag hello-world:latest 348949640551.dkr.ecr.ap-south-1.amazonaws.com/demo-app:latest
# docker push 348949640551.dkr.ecr.ap-south-1.amazonaws.com/demo-app:latest
